        ...
        <>
            {isVisible &&
                <div>
                    ...
                    <div
                        className={"bg-white h-[92vh] w-screen md:w-96 absolute top-full right-0 p-6 border border-custom-gray rounded overflow-auto z-50"}>
                        <div className={"flex justify-between items-center px-2 mb-6 text-xl"}>
                            <p className={"font-title-bold font-light text-custom-black"}>Search</p>
                        ...
                        {query === '' &&
                            <p className={"font-title-bold font-light text-lg text-custom-black"}>Type your search to
                        ...
                        {query && filteredItems.length === 0 && (
                            <p className="font-title-bold font-light text-lg text-custom-black">No results for "{query}".
                                Try again with different keywords.</p>
                        )}
                    </div>
                </div>
            }
